...
@Component
@RequestScope
public class SearchRefundRequestCompanyBatchWsProviderImpl extends WebServiceBase<SearchRefundRequestBatchRequest, SearchRefundRequestBatchResponse> {

    @Autowired
    private ConTbRefundRequestServiceImpl conTbRefundRequestService;

    @Autowired
    public SearchRefundRequestCompanyBatchWsProviderImpl(MessageHandler messageHandler) {
    ...
    protected SearchRefundRequestBatchResponse implement(SearchRefundRequestBatchRequest request) throws Exception {
        List<RefundRequestCompanyBatchBean> refundRequestCompanyBatchList = conTbRefundRequestService.searchRefundCompanyRequestBatch(request.getPaginable()
                , getUser(), request.getRefundRequestIds());
