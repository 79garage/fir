...
public class RequesterInsurerBatchRowMapper implements RowMapper<RequesterInsurerBatchBean> {

    @Override
    public RequesterInsurerBatchBean mapRow(@NonNull ResultSet rs, int rowNum)  throws SQLException {

        RequesterInsurerBatchBean bean = new RequesterInsurerBatchBean();
