...
public class RequesterEmployeeBatchRowMapper implements RowMapper<RequesterEmployeeBatchBean> {

    @Override
    public RequesterEmployeeBatchBean mapRow(@NonNull ResultSet rs, int rowNum)  throws SQLException {

        RequesterEmployeeBatchBean bean = new RequesterEmployeeBatchBean();
        ...
        bean.setPayeeNo(rs.getString("payee_no"));
        bean.setPayeeName(rs.getString("payee_name"));
