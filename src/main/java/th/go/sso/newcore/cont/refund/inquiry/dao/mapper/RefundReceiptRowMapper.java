...
public class RefundReceiptRowMapper implements RowMapper<RefundReceiptBean> {

    @Override
    public RefundReceiptBean mapRow(@NonNull ResultSet rs, int rowNum)  throws SQLException {

        RefundReceiptBean bean = new RefundReceiptBean();
