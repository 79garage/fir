...
public class SplitEmployeeRefundRowMapper implements RowMapper<SplitEmployeeRefundCompanyRequestBean> {

    @Override
    public SplitEmployeeRefundCompanyRequestBean mapRow(@NonNull ResultSet rs, int rowNum)  throws SQLException {

        SplitEmployeeRefundCompanyRequestBean bean = new SplitEmployeeRefundCompanyRequestBean();
...
//        bean.setDepartmentReceiveId(rs.getLong("department_receive_id"));
        ...
        bean.setRefundBankAccount(rs.getLong("refund_bank_account"));
