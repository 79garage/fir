...
public class RefundRequestInsurerBatchRowMapper implements RowMapper<RefundRequestInsurerBatchBean> {
    @Override
    public RefundRequestInsurerBatchBean mapRow(@NonNull ResultSet rs, int rowNum)  throws SQLException {

        RefundRequestInsurerBatchBean bean = new RefundRequestInsurerBatchBean();
